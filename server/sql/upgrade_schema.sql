...
CREATE TABLE USUARIO_SENHA (
    ...
    CPF VARCHAR(11) NOT NULL,      -- CPF (chave primária, FK para PESSOA.CPF)
    ...
    CONSTRAINT PK_USUARIO_SENHA PRIMARY KEY (CPF),
    CONSTRAINT FK_USUARIO_SENHA_PESSOA FOREIGN KEY (CPF)
        REFERENCES PESSOA (CPF)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
...
CREATE TABLE AUDITORIA_LOGIN (
    ...
    CPF VARCHAR(11),               -- CPF (pode ser NULL para tentativas de login falhadas)
    ...
    EMAIL_USUARIO VARCHAR(255),    -- Mantido para auditoria mesmo quando CPF não está disponível
    IP_ORIGEM VARCHAR(45),
    STATUS VARCHAR(20) NOT NULL,
    MENSAGEM TEXT,

    CONSTRAINT PK_AUDITORIA_LOGIN PRIMARY KEY (ID_LOG),
    CONSTRAINT FK_AUDITORIA_LOGIN_USER FOREIGN KEY (CPF)
        REFERENCES USUARIO_SENHA (CPF)
            ON DELETE SET NULL
            ON UPDATE CASCADE,
